...
//    private Stack<Operand> tmpOperandStack;
//    private Stack<Operator> tmpOperatorStack;
                ...
                if (Operand.check(token)) {
                    ...
                    if (token.equals(")")) {
                       ...
                       // && operatorStack.peek().equals("(")
                        ...
                        while (!operatorStack.empty() && operatorStack.peek().priority() >= newOperator.priority() && newOperator != Operator.getOperator("("))
                        {
